...
import com.example.sliding_menu1.Adapter.CalendarAdapter;
import com.example.sliding_menu1.R;
import com.example.sliding_menu1.menu.AnimatorUtils;
 ...
 * 作者： win
 * 创建日期：2016/4/19 15:08
 * 实现的主要功能：日历功能
 */
public class CalendarActivity extends Activity implements View.OnClickListener {
    private GestureDetector gestureDetector=null;//手势识别器
